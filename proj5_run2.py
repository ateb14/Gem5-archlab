...
preds = ['perceptron', 'mpperceptron', 'simple', 'tournament','local']
preds = ['perceptron']
...
for mis in range(2):
    for pred in preds:
        ...
        cmd = 'build/ARM/gem5.opt --outdir=configs/proj5/out/' + name + ' configs/proj5/two-level-copy.py' +' --cmd=' + str(mis) + ' --' + pred
        print(cmd)
